...
import mido
import numpy as np
from pysyphon import SyphonServer  # Import Syphon
...
# Video input setup
input_video_path = 0  # Replace with your input video path
...
# Syphon server setup
syphon = SyphonServer()
syphon.setName("My Syphon Output")
...
while True:
    ...
    if result.multi_hand_landmarks:
        for handLm in result.multi_hand_landmarks:
            ...
            for i in [0, 4, 8, 12, 16, 20]:
                ...
                x2, y2 = int(handLm.landmark[0].x * w), int(handLm.landmark[0].y * h)
            ...
            for i, distance in enumerate(distances):
                ...
                cc_message = mido.Message('control_change', channel=0, control=i+86, value=midi_value)
    ...
    syphon.publishFrame(np.flip(frame, 0))  # Flip frame vertically for correct orientation

    # Uncomment this to display locally if needed
